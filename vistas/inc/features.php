<div class="container">
    <div class="row">
        <div class="col-lg-4">
            <img src="<?php echo(BASE_URL) ?>/assets/img/crecimientoPersonal.png" alt="Crecimiento Personal" class="bd-placeholder-img rounded-circle" width="140" height="140">
        ...
        <div class="col-lg-4">
            <img src="<?php echo(BASE_URL) ?>/assets/img/bienestar.png" alt="Bienestar" class="bd-placeholder-img rounded-circle" width="140" height="140">
        ...
        <div class="col-lg-4">
            <img src="<?php echo(BASE_URL) ?>/assets/img/productividad.png" alt="productividad" class="bd-placeholder-img rounded-circle" width="140" height="140">
