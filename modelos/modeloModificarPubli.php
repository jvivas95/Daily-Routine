...
<body>
  <?php
  include_once __DIR__ . "/../vistas/inc/header.php";
  include_once __DIR__ . "/../vistas/inc/navigatorColum.php";
  include_once __DIR__ . "/../vistas/modificarPubli.php";
  include_once __DIR__ . "/../vistas/inc/navigatorFooter.php";
  ?>
